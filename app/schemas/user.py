...
class UserRegister(BaseModel):
    username: str = Field(min_length=6, max_length=16, description="username пользователя")
    ...
    last_name: str = Field(min_length=2, max_length=20, description="Фамилия пользователя")
    patronymic_name: Optional[str] = Field(default=None, min_length=2, max_length=20, description="Отчество пользователя")
...
class UserLogin(BaseModel):
    username: Optional[str] = Field(default=None, min_length=6, max_length=16,  description="username пользователя")
    email: Optional[EmailStr] = Field(default=None, description="email пользователя")
    phone_number: Optional[str] = Field(default=None, description="телефон пользователя")
